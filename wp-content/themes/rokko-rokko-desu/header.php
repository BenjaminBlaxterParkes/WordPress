		...
		<div class="container">
			<div class="flexbox">
				...
				<div class="flexbox__item  branding-container">
					...
					<img class="nav-logo" src="<?php echo home_url() ?>/wp-content/themes/rokko-rokko-desu/assets/images/nav/RokkoLogoHorzPinkYellowFull.png">
				</div>
				<div class="flexbox__item">
					<?php
					...
					<nav class="navigation  navigation--main<?php echo ( ! $has_main_menu ) ? '  no-menu' : ''; ?>" id="js-navigation--main">
						...
						<div class="social-links">
							<a href="https://www.facebook.com/rokkorokkodesucorporation/" target="_blank">
								<img src="<?php echo home_url() ?>/wp-content/themes/rokko-rokko-desu/assets/images/social/rokko_fb_social.png">
							</a>
							<a href="https://www.instagram.com/rokkorokko_desu/" target="_blank">
								<img src="<?php echo home_url() ?>/wp-content/themes/rokko-rokko-desu/assets/images/social/rokko_inst_social.png">
							</a>
						</div>
						<!--<?php
						wp_nav_menu( array(
